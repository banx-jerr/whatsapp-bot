...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  try {
    ...
    await conn.send3ButtonLoc(m.chat, await (await fetch(reyganz + 'APIKEY')).buffer(), text.trim(), '© by pangeran', 'Owner Bot', `,owner`, 'Group Wa', `,wanodejs`, 'Donasi owner', `,donasi`, m)
  } catch (e) {
